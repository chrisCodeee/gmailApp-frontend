...
const SuccessMessage = () => {
	...
	return (
		<div className="animate__animated animate__slideInDown" style={{ position: "absolute", top: "10px", right: "10px", borderRadius: "3px", backgroundColor: "rgba(0,0,0,0.9)", color: "#fff" }}>
